...
function App() {
  ...
  function handleAddTodo(e) { 
    ...
    if (name === "") return 
    setTodos(prevTodos => {  
      return [...prevTodos, { id: uuidv4(), name: name, complete: false, editItem: false }]
    })
  ...
  function confirmationButton() {
    const answer= window.confirm("Are you sure you want to delete the selected items?");
    if (answer) {
        handleClearTodos()
      }
  }
      ...
      <div className='container-fluid'>
        <form className='todo-form'>
          ...
          <div className="row justify-content-center row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2">
            ...
            <Button variant="outlined" className='col-9 col-sm-9 col-md-3 col-lg-3' color="error"component="label" onClick={confirmationButton}>Clear todos</Button>
          </div>
